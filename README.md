...
[![npm version](https://img.shields.io/npm/v/motion-mcp)](https://www.npmjs.com/package/motion-mcp)
...
| One-command install | 🟢 **✅ Yes** (`claude mcp add motion -- npx -y motion-mcp`) | N/A | N/A | N/A |
